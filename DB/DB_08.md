...
```python
dr = Director.objects.get(name = '봉준호')
print(f'id : {dr.id}')
print(f'name : {dr.name}')
print(f'debut : {dr.debut}')
print(f'country : {dr.country}')
```
...
```python
gr = Genre.objects.get(title = '드라마')
print(f'id : {gr.id}')
print(f'title : {gr.title}')
```
...
```python
mo = Movie.objects.filter(screening = True).order_by('opening_date')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
```python
director_ = Director.objects.get(name = '봉준호')
mo = Movie.objects.filter(director = director_).order_by('opening_date')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
```python
director_ = Director.objects.get(name = '봉준호')
mo = Movie.objects.filter(director = director_).order_by('opening_date')[1]
print(
  mo.director.name, 
  mo.genre.title, 
  mo.title, 
...
```python
mo = Movie.objects.filter(running_time__gt = 119).order_by('running_time')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
```python
mo = Movie.objects.filter(running_time__gte = 119).order_by('running_time')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
```python
mo = Movie.objects.filter(opening_date__gte = '2022-01-01' ).order_by('opening_date')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
mo = Movie.objects.filter(director = director_, genre = genre_).order_by('opening_date')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
...
mo = Movie.objects.exclude(director = director_).order_by('opening_date')
for i in mo : 
  print(
    i.director.name, 
    i.genre.title, 
